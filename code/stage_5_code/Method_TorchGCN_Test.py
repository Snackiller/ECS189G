...
class Method_TorchGCN_Test(method, nn.Module):
    data = None
    max_epoch = 200
    learning_rate = 0.01
    weight_decay = 5e-4
    ...
    def __init__(self, mName, mDescription, features_n, class_n):
        ...
        self.conv1 = GCNConv(features_n, 128).cuda()
        self.conv2 = GCNConv(128, class_n).cuda()
    ...
    def train(self, x, y):
        ...
        for epoch in range(self.max_epoch):
            ...
            if epoch % 5 == 0:
                print("Epoch:{} | Train Loss:{:.5f} Train Acc:{:.2f} | Valid Loss:{:.5f} Valid Acc:{:.2f} | Test Loss:{:.5f} Test Acc:{:.2f}".format(
                    epoch,
                    train_loss.item(),
                    train_acc,
                    valid_loss.item(),
    ...
    def train_score(self, X, y):
        ...
        f = open('../../result/stage_5_result/TorchGCN_Test_' + 'prediction_result' + '_Train', 'wb')
