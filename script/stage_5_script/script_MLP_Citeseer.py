...
from code.stage_5_code.Method_MLP import Method_MLP
...
if 1:
    ...
    data_obj = Dataset_Loader_New('Citeseer', '')
    data_obj.dataset_source_folder_path = '../../data/stage_5_data/citeseer/'
    data_obj.dataset_name = 'citeseer'


    method_obj = Method_MLP('MLP', '', 3703, 6)

    result_obj = Result_Saver('saver', '')
    result_obj.result_destination_folder_path = '../../result/stage_5_result/MLP_Citeseer_'
