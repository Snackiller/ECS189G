...
from code.stage_5_code.Method_TorchGCN_Test import Method_TorchGCN_Test
...
if 1:
    ...
    method_obj = Method_TorchGCN_Test('GCN', '', 1433, 7)

    result_obj = Result_Saver('saver', '')
    result_obj.result_destination_folder_path = '../../result/stage_5_result/TorchGCN_Pubmed_'
